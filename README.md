...
## 本项目获取地址：https://www.bishecode.com/product/256/
...
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图展示的就是管理员功能结构图，管理员在后台主要管理病例管理、字典管理、公告管理、药单管理、药品管理、药品收藏管理、药品评价管理、药品订单管理、牙医管理、牙医收藏管理、牙医评价管理、牙医挂号管理、用户管理、管理员管理等。

![alt text](images/image-1.png)

# 五、效果图展示【部分效果图】

图5.1 牙医列表页面【如图5.1显示的就是牙医列表页面，此页面提供给管理员的功能有：查看牙医、新增牙医、修改牙医、删除牙医等。】
...
图5.4药品管理页面【如图5.4显示的就是药品管理页面，此页面提供给管理员的功能有：新增药品,修改药品,删除药品。】
![alt text](images/image-5.png)

图5.5 药品类型管理页面【如图5.5显示的就是药品类型管理页面，此页面提供给管理员的功能有：新增药品类型,修改药品类型,删除药品类型。】
